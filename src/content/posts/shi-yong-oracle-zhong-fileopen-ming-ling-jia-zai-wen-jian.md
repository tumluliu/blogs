...
     这段代码来自csdn，3186489号帖子一位叫freddy2003的回复。令我感到以外又兴奋的是这段代码可以执行成功！多好的代码呀，可是帖主居然就一分都没给freddy2003<img src="/Emoticons/emsad.gif" data-align="absMiddle" data-border="0" />，没错，csdn中的有些发帖者就是这么怪异:-\$     这样我就开始解剖freddy2003的这段代码，缩减、改编到最后变成：
